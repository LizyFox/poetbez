...
<div class="authors-section__text mt-5">
	<h2 class="h2"><?=GetMessage('AGENT_H2');?></h2>
	<?$APPLICATION->IncludeFile(
		SITE_DIR."include/authors-section-text.php",
		Array(),
		Array("MODE"=>"html")
	);?>
	<div class="button btn_red btn_blick mt-4 mt-md-5 px-4 px-sm-5 mx-auto"><?=GetMessage('BTN_BECOME_AGENT');?></div>
</div>
